...
int numberOfPacketLossesToSimulateMax=
    numberOfPacketsToSimulateMax; // How many packet losses to simulate (at most) for each system-load value
...
string fileName = "FA_FNB_38_delay_05.txt";
